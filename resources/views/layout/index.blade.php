...
@include('partials.header')
  ...
  <div id="hero" class="hero route bg-image" style="background-image: url({{asset('template/assets/img/hero-bg.jpg')}})">
    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        ...
        <h1 class="hero-title mb-4">I am {{ $nama }}</h1>
  ...
  <main id="main">
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        <img src="{{asset('template/assets/img/nazmip3ppp.jpg')}}" class="img-fluid rounded b-shadow-a" alt="">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        ...
                        <p><span class="title-s">Phone: </span> <span>{{ $telp }}</span></p>
                        <p><span class="title-s">graduate: </span> <span>{{ $graduate }}</span></p>
                      </div>
                    </div>
                  </div>
                  <div class="skill-mf">
    ...
    <!-- ======= Counter Section ======= -->
    <div class="section-counter paralax-mf bg-image" style="background-image: url({{asset('template/assets/img/counters-bg.jpg')}})">
    ...
    <section id="work" class="portfolio-mf sect-pt4 route">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="work-box">
              <a href="{{asset('template/assets/img/work-1.jpg')}}" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="{{asset('template/assets/img/work-1.jpg')}}" alt="" class="img-fluid">
                </div>
              </a>
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="{{asset('template/assets/img/work-2.jpg')}}" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="{{asset('template/assets/img/work-2.jpg')}}" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="{{asset('template/assets/img/work-3.jpg')}}" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="{{asset('template/assets/img/work-3.jpg')}}" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="{{asset('template/assets/img/work-4.jpg')}}" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="{{asset('template/assets/img/work-4.jpg')}}" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
