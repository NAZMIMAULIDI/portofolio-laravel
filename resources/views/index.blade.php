...
@section('container') 
  ...
  <!-- ======= Hero Section ======= -->
  <div id="hero" class="hero route bg-image" style="background-image: url({{asset('template/assets/img/nazmip3sampul.jpg')}})">
          ...
          <div class="col-md-4">
            <div class="work-box">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">{{ $port->title }}</h2>
                    <div class="w-more">
                      <span class="w-ctegory">{{ $port->created_at}}</span> / <span 
                      class="w-date">{{ $port->created_at }}</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
